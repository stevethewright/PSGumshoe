...
.DESCRIPTION
    Clear-WinEvent cmdlet gets events from event logs, including classic logs, such as the System
    and Application logs and the event logs that are generated by the Windows Event Log technology
    introduced in Windows Vista. A path and file name can be specified to save the contents of the
    eventlog before it is cleared.
.EXAMPLE
