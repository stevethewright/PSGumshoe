...
function Get-EventScheduledTaskComplete {
    ...
    param (
        ...
        # Context under which the task ran under.
        [Parameter(Mandatory = $false,
                   ValueFromPipelineByPropertyName = $true)]
        [string[]]
        $UserContext,
    ...
    process {
        Search-EventLogEventData -EventId 102 -ParamHash $Params -Provider "Microsoft-Windows-TaskScheduler" -RecordType "ScheduledTaskCompleted"
