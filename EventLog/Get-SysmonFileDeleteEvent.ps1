...
.DESCRIPTION
    File delete operations are logged when a file is deleted. This event is useful
    for monitoring when a piece of malware or an actor deleted files to cover their tracks.
.EXAMPLE
