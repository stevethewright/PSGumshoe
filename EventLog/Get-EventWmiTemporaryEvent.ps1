...
function Get-EventWmiTemporaryEvent {
    ...
    process {
        Search-EventLogUserData -EventId 5860 -Provider "Microsoft-Windows-WMI-Activity" -ReturnRecord -SubElement -ParamHash $MyInvocation.BoundParameters | ForEach-Object {
            [xml]$evtxml = $_.toxml()
            $ProcInfo = [ordered]@{}
